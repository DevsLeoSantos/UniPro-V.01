const ProdutosUnipro = [
  ...
  },
  {
    ...
    descricao:
      "Selante e adesivo a base de polímeros híbridos desenvolvido para aplicações de fixações em sistemas de envidraçamento de ambientes.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
  ...
  },
  {
    ...
    descricao:
      "Selante de silicone de cura neutra para uso profissional. Cura em contato com a umidade atmosférica,transformando-se em uma borracha flexível e impermeável.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
  ...
  },
  {
    ...
    descricao:
      "Adesivo a base de polímeros híbridos, de consistência pastosa, com propriedades de não escorrimento. Isento de solventes, não provoca manchas na superfície dos espelhos.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
  ...
  },
  {
    ...
    descricao:
      "Adesivo extra forte monocomponente, formulado a base de polímero híbrido e isento de solventes e hidrocarbonetos, que seca por absorção de umidade e temperatura ambiente.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
  ...
  },
  {
    ...
    descricao:
      "Adesivo de alta pega inicial de uso profissional à base de polímeros híbridos. Não provoca manchas nas superfícies.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
  ...
  },
  {
    ...
    imgbgproduto: "/imagens/BgProdutos/bg_pu40.svg",
    descricao:
      "Selante monocomponente à base de Polimero Hibrido de alta perfomace, especialmente desenvolvido para as diversas aplicações existentes na construção civil.",
    disponivel: "Tubos 400g / Sachê 820g",
    aplicacao:
      "Juntas de dilatação vertical e horizontal para estruturas ou paineis pré-fabricados em concreto com movimentação de até 12,5%.",
  ...
  },
  {
    ...
    fichaTécnica: "",
    fispq: "",
    especificacoes: "/imagens/Brocas_Rebites.pdf",
  ...
  },
  {
    ...
    fichaTécnica: "",
    fispq: "",
    especificacoes: "/imagens/Parafusos.pdf",
    translateKey: "paraf",
  },
  {
    id: 13,
    ...
    fichaTécnica: "",
    fispq: "",
    especificacoes: "/imagens/Buchas.pdf",
    translateKey: "bucha",
  },
  {
    id: 14,
    ...
    fichaTécnica: "",
    fispq: "",
    especificacoes: "/imagens/Discos.pdf",
    translateKey: "disco",
  },
  {
    id: 15,
    ...
    fichaTécnica: "",
    fispq: "",
    especificacoes: "/imagens/Brocantes.pdf",
    translateKey: "broc",
  },
];
