        ...
        <>
            <div data-aos="zoom-in-down" className="Desk_Conteiner__main">
                ...
                <div className="Desk_Conteiner__left">
                    <h1 className="Desk_Conteiner__left_line">LINHA BROCA E REBITE</h1>
                    <h2>APLICAÇÃO</h2>
                    <p>Brocas, rebites e ponteiras. Diversas medidas, confira nossas Especificações ou entre em contato conosco.</p>
                ...
                <div className="Desk_Conteiner__center">
                    <img src={'/imagens/Produtos/Broca.png'} alt={'Parafuso Brocante'}></img>
                </div>
                <div className="Desk_Conteiner__right">
                    <h1>Broca e Rebite</h1>
            ...
            <div className="Produtos__main">
                ...
                <div style={{ backgroundImage: `url(${''})` }} className="Produtos__Mobile">
                    <div >
                        <img src={'/imagens/Produtos/Broca.png'} alt={''}></img>
                    </div>
                </div>
                <div className="Produtos__text"> 
                    <h1 className="Produtos__text_name">Broca e Rebite</h1>
                    <h1 className="Produtos__text_line">LINHA BROCA E REBITE</h1>
                </div>
