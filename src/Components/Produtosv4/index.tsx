        ...
        <>
            <div data-aos="zoom-in-down" className="Desk_Conteiner__main">
                ...
                <div className="Desk_Conteiner__left">
                    ...
                    <h2>APLICAÇÃO</h2>
                    <p>Bucha nylon, plastica com e sem anel e bucha tijolo baiano. Diversas medidas, confira nossas Especificações ou entre em contato conosco.</p>
                ...
                <div className="Desk_Conteiner__center">
                    <img src={'/imagens/Produtos/Bucha.png'} alt={'Parafuso Brocante'}></img>
                </div>
                <div className="Desk_Conteiner__right">
                    ...
                    <div className="Desk_Conteiner__right_budget">
                        ...
                        <div className="Desk_Conteiner__right_side">
                            <a className="Desk_right_budget Desk_side" href={'/imagens/Buchas.pdf'} download>Especificações</a>
            ...
            <div className="Produtos__main">
                ...
                <div style={{ backgroundImage: `url(${''})` }} className="Produtos__Mobile">
                    <div >
                        <img src={'/imagens/Produtos/Bucha.png'} alt={''}></img>
                    </div>
                </div>
                <div className="Produtos__text"> 
                    <h1 className="Produtos__text_name">Buchas</h1>
                ...
                <div className="Produtos__conteudo">
                    ...
                    <div className='ConteinerBotao botaoside'>
                        <a href="/imagens/Buchas.pdf" download>Especificações</a>
